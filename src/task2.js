...
var fetchMockData = function (option) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("https://jsonplaceholder.typicode.com/".concat(option))];
            case 1:
                reponse = _a.sent();
            ...
            case 3:
                err_1 = _a.sent();
                return [2 /*return*/, { status: "error", error: JSON.stringify(err_1) }];
...
// fetchMockData("posts")
var apiPath = function (postId) { return "comments?postId=".concat(postId); };
var fetchComments = R.compose(fetchMockData, apiPath)(3);
